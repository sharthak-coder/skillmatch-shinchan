  ...
  return (
    <header className="sticky top-0 z-50 bg-[#FFFDF9]/90 backdrop-blur-md border-b-2 border-shin-ink px-4 sm:px-8 py-3 transition-all">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        {/* If on /login page, show the exact mockup right side: "Good skills Good vibes!" with Shin-chan face */}
        {pathname === '/login' ? (
          <div className="flex items-center gap-2.5">
            <span className="text-xs sm:text-sm font-bold text-slate-700 italic font-mono">
              &ldquo;Good skills Good vibes!&rdquo;
            </span>
            <img
